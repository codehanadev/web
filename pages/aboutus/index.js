...
export default function AboutUs() {
    return <>
        ...
        <div className={styles.Details}>
            <div className={styles.details}>
                <p>Nathan and Simeon are lifelong friends and professional colleagues. Both experienced coders and software engineers, Ed and Eric have more than 30 years of combined experience in the tech sector and have worked for successful companies including Hertz, AOL, Boxed, Townsquare Media, etc.</p>
